        ...
        <v-layout row wrap>
          <v-flex xs12>
            ...
            <v-stepper v-model="e1">
              ...
              <!-- alert 표시 -->
              <v-alert class="mb-3" :value="isSubmitDup" type="error">이미 제출했습니다.</v-alert>
              <v-alert class="mb-3" :value="isSubmitError" type="error">장애가 발생했습니다. 잠시만 기다려주세요.</v-alert>
              <v-alert class="mb-3" :value="islocationError" type="error">위치 정보가 잘못되었습니다. 다시 입력해주세요.</v-alert>
              <v-alert class="mb-3" :value="alreadySeller" type="error">이미 제출한 유저입니다.</v-alert>
                      ...
                      <div class="text-xs-center">
                        <v-dialog v-model="dialog" width="500">
                          <template v-slot:activator="{ on }">
                            <v-btn color="primary" dark v-on="on">위치 검색</v-btn>
                          </template>
                ...
                <v-stepper-content step="4">
                  <v-card class="mb-5" height="100%">
                    <v-container
                      ...
                      grid-list-md
                    >
                      <v-layout v-scroll label="약관" class="grey lighten-4">{{userTerms}}</v-layout>
                    </v-container>
                    <v-checkbox
                      v-model="checkbox"
  ...
  computed: {
    ...
    ImageErrors() {
      ...
      !this.$v.imageName.required &&
        errors.push("Seller Authentication Image is required");
      return errors;
    },
    ImageErrors2() {
      const errors = [];
